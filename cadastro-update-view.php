...
<head>
    ...
    <script>
        function confirmarAlteracao() {
            var confirmacao = confirm("Tem certeza de que deseja alterar o jogo?");
            if (confirmacao) {
                var formulario = document.querySelector("form-update-c");
                formulario.submit();
            }
        }
    </script>
...
<body>
    ...
    <div class="corpo-form">
        <div class="form">
            ...
            <form id="form-update-c"  action="cadastro-update.php" method="post">
                <div class="inputs">
                ...
                <button class="button" type="submit" onclick="confirmarAlteracao()">Atualizar Jogo</button>
            </form>
            <div class="li-icons">
                <ul>
                    <li><a href="cadastro-view.php"><img src="img/cadastro.png" alt="img pc" width="30px" height="30px"></a></li>
