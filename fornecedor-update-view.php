...
<head>
    ...
    <title>Update de Fornecedores</title>
    ...
    function confirmarAtualizacao() {
        ...
        var confirmacao = confirm("Tem certeza de que deseja atualizar o fornecedor?");

        // Se o usuário confirmar, envie o formulário
        if (confirmacao) {
            // Obtém o formulário
            var formulario = document.getElementById("form-update"); // Substitua "seuFormulario" pelo ID do seu formulário
...
<body>
    ...
    <div class="corpo-form">
        <div class="form">
            ...
            <form action="fornecedor-update.php" method="post" id="form-update">
                <div class="inputs">
                </select>
                ...
                <button class="button" type="submit" onclick="confirmarAtualizacao()" >Atualizar Fornecedor</button>
            </form>
            <div class="li-icons">
                <ul>
                    <li><a href="fornecedor-view.php"><img src="img/cadastro.png" alt="img pc" width="30px" height="30px"></a></li>
