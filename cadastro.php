...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $quantidade_fornecedor = "SELECT COUNT(*) FROM fornecedores;";
    if ($stmtVerifica->num_rows > 0 ) {
        ...
        $sql = "INSERT INTO Jogos (nome, desenvolvedor, anoLancamento, Categorias_idCategorias, Fornecedores_idFornecedores, valor, imagem) VALUES (?, ?, ?, ?, ?, ?, ?)";
